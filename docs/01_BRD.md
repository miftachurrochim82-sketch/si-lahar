...
> - **v2.1.0 (2026-09-19)** — G18d: adopsi CoreLib v2.3.0 (util sadar-WIB + paginasi/pencarian),
>   konvergensi frontend v1→v2 (cleanup file orphan & dead code), bump pin 15 + CDN `@v2.8.1`.
...
| App ekosistem | `si-platform` (SSO), SIMPEG (3 referensi otomatis), **CoreLib v2.3.0 pin 15**, **CDN kit v2.8.1** |
...
- **CoreLib First**: seluruh util generik (tanggal, paginasi, pencarian, whitelist, role)
  memakai CoreLib. Sejak v2.3.0 pin 15, util sadar-WIB (`CoreLib.todayIsoLocal()`,
...
- **CDN kit v2.8.1**: seluruh UI (badge, modal, tabel, filter, chart, picker) memakai
